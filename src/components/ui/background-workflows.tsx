...
const workflowDefs: WorkflowDef[] = [
  // Reception: Symmetric fan-out, converge at end
  {
    ...
    nodes: [
      ...
      { icon: "psychology", label: "AI Speech-to-Text", tip: "", cx: 1.5, cy: 0.12, tipSide: "bottom" },
      { icon: "account_tree", label: "Intent Detection", tip: "", cx: 2, cy: 0.28, tipSide: "top" },
      { icon: "auto_fix_high", label: "Personalize", tip: "", cx: 2, cy: 0.62, tipSide: "bottom" },
      { icon: "folder_open", label: "Knowledge Base", tip: "", cx: 1.5, cy: 0.82, tipSide: "top" },
      { icon: "hub", label: "Update CRM", tip: "", cx: 4.5, cy: 0.18, tipSide: "top" },
      { icon: "mail", label: "Send Email", tip: "", cx: 4.5, cy: 0.72, tipSide: "bottom" },
  ...
  // Speed: Cascade down then up, with cross-connections
  {
    ...
    nodes: [
      ...
      { icon: "filter_alt", label: "Lead Scoring", tip: "", cx: 1.5, cy: 0.14, tipSide: "bottom" },
      { icon: "search", label: "Social Scan", tip: "", cx: 2.5, cy: 0.30, tipSide: "top" },
      { icon: "contacts", label: "Contact Info", tip: "", cx: 1.5, cy: 0.60, tipSide: "bottom" },
      { icon: "psychology", label: "AI Enrichment", tip: "", cx: 2.5, cy: 0.78, tipSide: "top" },
      { icon: "mail", label: "Custom Email", tip: "", cx: 5, cy: 0.22, tipSide: "top" },
      { icon: "notification_important", label: "Alert SMS", tip: "", cx: 5, cy: 0.68, tipSide: "bottom" },
      { icon: "task_alt", label: "Lead Engaged", tip: "", cx: 7.5, cy: 0.42, tipSide: "left" },
    ],
    paths: [
      { from: 0, to: 1, dir: "up" },
      { from: 0, to: 3, dir: "down" },
  ...
  // Marketing: Diamond with extra cross
  {
    ...
    nodes: [
      ...
      { icon: "psychology", label: "AI Repurpose", tip: "", cx: 2, cy: 0.10, tipSide: "bottom" },
      { icon: "auto_awesome", label: "Generate Hooks", tip: "", cx: 3, cy: 0.25, tipSide: "top" },
      { icon: "work", label: "LinkedIn Post", tip: "", cx: 2, cy: 0.58, tipSide: "bottom" },
      { icon: "photo_camera", label: "Instagram", tip: "", cx: 3, cy: 0.75, tipSide: "top" },
      { icon: "campaign", label: "Newsletter", tip: "", cx: 5, cy: 0.15, tipSide: "top" },
      { icon: "schedule", label: "Auto Schedule", tip: "", cx: 5, cy: 0.70, tipSide: "bottom" },
      { icon: "analytics", label: "Traffic Surge", tip: "", cx: 7.5, cy: 0.42, tipSide: "left" },
    ],
    paths: [
      { from: 0, to: 1, dir: "up" },
      { from: 0, to: 3, dir: "down" },
  ...
  // Growth: Asymmetric, heavier on top
  {
    ...
    nodes: [
      ...
      { icon: "psychology", label: "Sentiment", tip: "", cx: 1.5, cy: 0.12, tipSide: "bottom" },
      { icon: "auto_fix_high", label: "AI Reply", tip: "", cx: 2.5, cy: 0.22, tipSide: "top" },
      { icon: "code", label: "Testimonials", tip: "", cx: 1.5, cy: 0.65, tipSide: "bottom" },
      { icon: "share", label: "Social Share", tip: "", cx: 3, cy: 0.80, tipSide: "top" },
      { icon: "groups", label: "Facebook", tip: "", cx: 5, cy: 0.18, tipSide: "top" },
      { icon: "trending_up", label: "SEO Boost", tip: "", cx: 5, cy: 0.65, tipSide: "bottom" },
  ...
  // Sales: Spiral-like routing
  {
    ...
    nodes: [
      ...
      { icon: "psychology", label: "AI Personalize", tip: "", cx: 1.5, cy: 0.18, tipSide: "bottom" },
      { icon: "insights", label: "Company Data", tip: "", cx: 2.5, cy: 0.32, tipSide: "top" },
      { icon: "connect_without_contact", label: "LinkedIn", tip: "", cx: 2, cy: 0.58, tipSide: "bottom" },
      { icon: "mark_email_unread", label: "Cold Email", tip: "", cx: 2, cy: 0.82, tipSide: "top" },
      { icon: "storage", label: "Sync CRM", tip: "", cx: 5, cy: 0.20, tipSide: "top" },
      { icon: "gps_fixed", label: "Meeting Booked", tip: "", cx: 4.5, cy: 0.62, tipSide: "bottom" },
